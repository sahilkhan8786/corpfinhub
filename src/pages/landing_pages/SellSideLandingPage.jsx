        ...
        <section>
            ...
            <div className='w-full bg-[#F8F8F8] py-12'>
                ...
                <article className={`w-full mx-auto max-w-[1440px]  px-4 md:p-0 mb-12  `}>
                    <h1 className='font-semibold text-[#0D0D0D] text-[50px] p t-12'>
                        Helping Sellers
                    </h1>
                    <p className='text-[16px] text-[#3B3B3B] text-center w-full xl:w-[1181px]'>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                    </p>

                    <div className='flex items-center justify-center gap-4 my-8 '>
                        <article className='my-12'>
                            <h1 className='font-medium text-[18px] text-[#0D0D0D]'>Worem</h1>
            ...
            <div className='max-w-[1440px] mx-auto w-full flex justify-center my-12'>
                <img src="/Pdf Viewer.png" alt="" />
            </div>
            <div className='flex w-full max-w-[1440px] mx-auto justify-between px-4 gap-16 py-12'>
                ...
                <article className='flex-1  w-full flex flex-col justify-evenly items-start'>
                    <h1 className='font-semibold text-[38px] text-[#0D0D0D] '>Off-market</h1>
                    <div>
                        <h1 className='font-medium text-[26px] text-[#0D0D0D] '>Lorem Ipsum</h1>
                        <p className='w-full sm:w-[544px] text-[#3B3B3B]'>Quis imperdiet massa tincidunt nunc pulvinar sapien et ligula. Sagittis orci a scelerisque purus semper eget duis at. Justo nec ultrices dui sapien eget mi proin sed libero. Massa eget egestas purus viverra accumsan in nisl.</p>
                    </div>
                    <div className='w-[545px] flex items-center justify-center '>
            ...
            <div className='w-full flex max-w-[1440px] mx-auto my-12'>
                ...
                mt-16 '>
                    <div>
                        ...
                        <p className='text-[#3B3B3B] text-[18px]'>Explore our tailored insurance solutions and experience the peace of mind that comes with knowing you're covered.</p>
                    </div>
