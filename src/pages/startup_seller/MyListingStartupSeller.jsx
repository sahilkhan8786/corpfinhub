                        ...
                        <div className='flex justify-between w-full gap-4 flex-col md:flex-row'>
                            ...
                            <article className='flex flex-col justify-between relative overflow-hidden'>
                                ...
                                <div className='flex justify-between flex-wrap gap-3 lg:flex-nowrap lg:gap-0 '>
                                    ...
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>Valuation</h1>
                                        <p className='text-primary text-[12px] font-medium'>76.2</p>
                                    </aside>
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>Amount raised</h1>
                                        <p className='text-primary text-[12px] font-medium'>£2.84 m</p>
                                    </aside>
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>Funding Stage</h1>
                                        <p className='text-primary text-[12px] font-medium'>Start</p>
                                    </aside>
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>CAC</h1>
                                        <p className='text-primary text-[12px] font-medium'>76.2</p>
                                    </aside>
                                </div>
                                <div className='flex justify-between flex-wrap gap-3 lg:flex-nowrap lg:gap-0'>
                                    ...
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>Churn rate</h1>
                                        <p className='text-primary text-[12px] font-medium'>76.2</p>
                                    </aside>
                                    <aside className='flex-1'>
                                    ...
                                    <aside className='flex-1'>
                                        <h1 className='font-medium text-[14px]'>ARR</h1>
                            ...
                            <article className='flex flex-col justify-between gap-4'>
                                ...
                                <button className='bg-primary text-white p-4 hover:opacity-80'>Evaluate Buyers</button>
