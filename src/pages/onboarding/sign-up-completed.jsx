...
const SignupCompleted = () => {
    return (
        <section className='flex items-center justify-center w-full md:w-[556px] h-screen flex-col gap-7 md:mx-auto px-2'>
            <img src="/completed.png" alt="" />
            <h1 className='text-[#18191c] font-medium text-[16px] px-2 md:px-0'>🎉 Congratulations, Your sign up is complete!</h1>
            ...
            <div className='flex items-center justify-center w-full md:w-[410px] gap-4 flex-row '>
