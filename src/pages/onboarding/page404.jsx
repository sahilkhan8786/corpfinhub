        ...
        <section className='min-h-[90vh] w-full relative py-12'>
            ...
            <div className='w-full max-w-[1400px] mx-auto flex items-center justify-center h-full px-4 flex-col gap-4 lg:flex-row'>
                <div className='flex flex-col gap-3  w-full md:w-[585px]'>
                    ...
                    <div className='flex gap-2 pr-6 items-center justify-between flex-col md:flex-row min-w-[258px]'>
            ...
            <div className='flex gap-4 flex-col md:absolute md:-bottom-10 md:left-24'>
                <p>Follow Us</p>
            ...
            <p className='font-normal text-[#767F8C] text-[14px] md:absolute md:right-24 md:-bottom-10'>@ 2024 All rights Reserved - Chasvi Co</p>
        </section>
    )
}
